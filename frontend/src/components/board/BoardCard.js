...
const BoardCard = ({ board, onUpdated, onDeleted }) => {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="position-relative" style={{ height: 180, background: '#f8f9fa' }}>
                    ...
                    <button
                        ...
                        style={{
                            top: 10, right: 10, borderRadius: '12px', padding: '6px 10px',
                            boxShadow: '0 .25rem .75rem rgba(0,0,0,.12)', minWidth: '60px',
              ...
              <Lock size={14} /> Private
                ...
                <Card.Body className="d-flex flex-column">
                    <Card.Title className="mb-1 text-truncate" title={board.name} style={{ fontSize: '1.05rem', fontWeight: 700, lineHeight: 1.2 }}>
                        {board.name}
                    </Card.Title>
            ...
            <EditBoardModal
                ...
                board={board}
                onUpdated={(updated) => { onUpdated && onUpdated(updated); }}
                onDeleted={(deletedId) => { onDeleted && onDeleted(deletedId); }}
            />
        </>
    );
};
