...
const ActionButton = ({icon, onClick, alt, animationKey}) => (<motion.button
    ...
    style={{
        outline: 'none', boxShadow: 'none', borderColor: 'transparent', background: 'transparent',
    }}
>
    <motion.img
        key={animationKey}
...
const CommentInput = ({newComment, setNewComment, onPost}) => (<div className="input-group mb-3">
    <input
        type="text"
...
const CommentList = ({comments, loading}) => {
    ...
    return (<ul className="list-unstyled">
        {comments.map((c) => (<li key={c.id} className="d-flex mb-3 align-items-start">
            <img
