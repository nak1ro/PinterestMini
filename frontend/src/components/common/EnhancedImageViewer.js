...
/**
 * Enhanced image viewer with pinch-to-zoom, pan, and swipe-down to dismiss
 */
const EnhancedImageViewer = ({ show, imageUrl, imageAlt, onClose, isMobile }) => {
    ...
    const handleTouchStart = (e) => {
        if (e.touches.length === 2) {
            ...
            // Single finger swipe down to dismiss (only when not zoomed)
    ...
    const handleTouchEnd = (e) => {
        ...
        // Check if swipe was significant enough to close
